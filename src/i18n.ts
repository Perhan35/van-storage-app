...
const resources = {
  en: {
    translation: {
      ...
      "out.currently_out_one": "{{count}} item currently out",
      "out.currently_out_other": "{{count}} items currently out",
  ...
  fr: {
    translation: {
      ...
      "out.currently_out_one": "{{count}} objet actuellement sorti",
      "out.currently_out_other": "{{count}} objets actuellement sortis",
